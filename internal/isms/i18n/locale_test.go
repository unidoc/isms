...
func TestCanonical(t *testing.T) {
	...
	tests := []struct {
		...
		{"bare language de", "de", "de-DE", true},
		{"unsupported region falls back to de-DE", "de-AT", "de-DE", true},
		{"bare language es", "es", "es-ES", true},
		{"unsupported region falls back to es-ES", "es-MX", "es-ES", true},
		{"bare language fr", "fr", "fr-FR", true},
		{"unsupported region falls back to fr-FR", "fr-CA", "fr-FR", true},
		...
		{"unknown with region", "ko-KR", "", false},
		{"empty", "", "", false},
...
func TestResolve(t *testing.T) {
	...
	tests := []struct {
		...
		{"unsupported user locale falls through to org", "ko", "id-ID", "id-ID"},
		{"unsupported at every tier falls back", "ko", "nl", Default},
...
func TestFromAcceptLanguage(t *testing.T) {
	...
	tests := []struct {
		...
		{"skips unsupported and takes next", "ko, nl, id-ID", "id-ID", true},
		...
		{"empty header", "", "", false},
		{"nothing supported", "ko-KR, nl-NL", "", false},
